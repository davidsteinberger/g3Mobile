...
- (void)createModel {
  self.dataSource = [TTSectionedDataSource dataSourceWithObjects:
	@"JSON",
	[TTTableTextItem itemWithText:@"comments" URL:@"tt://comments/6502"],
	[TTTableTextItem itemWithText:@"comments" URL:@"tt://controller/6502"],
					 
    @"Photos",
    [TTTableTextItem itemWithText:@"Photo Browser" URL:@"tt://photoTest1"],
    [TTTableTextItem itemWithText:@"Photo Thumbnails" URL:@"tt://photoTest2/1"],
